...
public class CsvField {
	...
	public static CsvField parse(final int index, final String attribute, final char quotationCharacter) {
		...
		return new CsvField(
				index,
				matches.group("name"),
				matches.group("fieldtype"),
				matches.group("array").equals("[]"),
				Optional.of(matches.group("idSpace"))
		);
	}
//
